...
enum class Currency(val flagResId: Int, val currencyName: Int, val visible: Boolean) {
    ...
    AUD(R.drawable.ic_australian_flag, R.string.AUD, true),
    BGN(R.drawable.ic_bulgaria, R.string.BGN, true),
    BRL(R.drawable.ic_brazil, R.string.BRL, true),
    CAD(R.drawable.ic_canada, R.string.CAD, true),
    CHF(R.drawable.ic_switzeland, R.string.CHF, true),
    CNY(R.drawable.ic_china, R.string.CNY, true),
    CZK(R.drawable.ic_czech_republic, R.string.CZK, true),
    DKK(R.drawable.ic_unkonw_flag, R.string.DKK, false),
    GBP(R.drawable.ic_united_kingdom, R.string.GBP, true),
    HKD(R.drawable.ic_hongkong, R.string.HKD, true),
    ...
    JPY(R.drawable.ic_japan, R.string.JPY, true),
    KRW(R.drawable.ic_unkonw_flag, R.string.KRW, false),
    MXN(R.drawable.ic_mexico, R.string.MXN, true),
